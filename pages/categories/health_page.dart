...
class HealthPageState extends State<HealthPage> {
  ...
  final Map<String, double> _categoryExpenses = {
    "med_medications_pharmacy_products": 0.0,
    "med_doctor_visits_examinations": 0.0,
    "med_treatments_chronic_conditions": 0.0,
    "med_dentistry_optometry": 0.0,
    "med_physical_therapy_orthopedic_services": 0.0,
    "med_psychological_cosmetic_services": 0.0,
    "med_emergency_vaccination": 0.0,
  };

  bool _areBoxesOpened = false;
  final List<String> _categories = [
    "med_medications_pharmacy_products",
    "med_doctor_visits_examinations",
    "med_treatments_chronic_conditions",
    "med_dentistry_optometry",
    "med_physical_therapy_orthopedic_services",
    "med_psychological_cosmetic_services",
    "med_emergency_vaccination"
  ];
  ...
  Future<void> _loadSettings() async {
    ...
    List<String>? savedNewCategories = settingsBox.get('health_new_categories')?.cast<String>();
  ...
  Future<void> _saveNewCategories() async {
    await settingsBox.put('health_new_categories', _newCategories);
  }
  ...
  void _updateCategoryExpense(String category, double newSum) {
    if (_categoryExpenses[category] != newSum) {
      ...
      settingsModel.updateCategoryExpense("health", _totalExpense);
    }
  }

  @override
  Widget build(BuildContext context) {
    String pageTitle = Localization.getTranslation('health');
        ...
        children: [
          ...
          SizedBox(
            ...
            child: TotalContainer(
              ...
              categoryName: 'health', // Указание категории
            ),
          ),
        ],
      ),
