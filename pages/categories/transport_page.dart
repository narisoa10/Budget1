...
class TransportPageState extends State<TransportPage> {
  ...
  final Map<String, double> _categoryExpenses = {
    "transport_fuel": 0.0,
    "transport_maintenance": 0.0,
    "transport_parking_fees": 0.0,
    "transport_toll_roads": 0.0,
    "transport_public_transport": 0.0,
    "transport_taxi_ridesharing": 0.0,
    "transport_car_rental": 0.0,
    "transport_repairs": 0.0,
    "transport_miscellaneous": 0.0,
  };
  ...
  final List<String> _categories = [
    ...
    'transport_parking_fees',
    'transport_toll_roads',
    'transport_public_transport',
    'transport_taxi_ridesharing',
  ...
  Future<void> _loadSettings() async {
    ...
    List<String>? savedNewCategories = settingsBox.get('transport_new_categories')?.cast<String>();
  ...
  Future<void> _saveNewCategories() async {
    await settingsBox.put('transport_new_categories', _newCategories);
  }
  ...
  void _updateCategoryExpense(String category, double newSum) {
    if (_categoryExpenses[category] != newSum) {
      ...
      settingsModel.updateCategoryExpense("transport", _totalExpense);
    }
  }

  @override
  Widget build(BuildContext context) {
    String pageTitle = Localization.getTranslation('transport');
        ...
        children: [
          ...
          SizedBox(
            ...
            child: TotalContainer(
              ...
              categoryName: 'transport', // Указание категории
            ),
          ),
        ],
      ),
