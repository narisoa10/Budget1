...
class InsurancePageState extends State<InsurancePage> {
  ...
  Future<void> _loadSettings() async {
    ...
    List<String>? savedNewCategories = settingsBox.get('insurance_new_categories')?.cast<String>();
  ...
  Future<void> _saveNewCategories() async {
    await settingsBox.put('insurance_new_categories', _newCategories);
  }
  ...
  void _updateCategoryExpense(String category, double newSum) {
    if (_categoryExpenses[category] != newSum) {
      ...
      settingsModel.updateCategoryExpense("insurance", _totalExpense);
    }
  }

  @override
  Widget build(BuildContext context) {
    String pageTitle = Localization.getTranslation('insurance');
        ...
        children: [
          ...
          SizedBox(
            ...
            child: TotalContainer(
              ...
              categoryName: 'insurance', // Указание категории
            ),
          ),
        ],
      ),
